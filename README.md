...
GraphMet-1 is developed and maintained by The Ohio State University's Byrd
Polar and Climate Research Center.

If you are interested in using GraphMet-1 for educational purposes or
collaborating with us to develop GraphMet-1 for a specific application, please
email [gravina.2@osu.edu](mailto:gravina.2@osu.edu).

For more information, visit the Help & About menu at
[GraphMet-1](https://fluid-earth.byrd.osu.edu/).
...
GraphMet-1 comes with a lightweight web component which can be included in
