# GraphMet-1 web component


## Description

GraphMet-1 comes as a freestanding application, but it also includes a simplified web
component that can be integrated into other web sites. If you want to make use of
GraphMet-1 in your own applications, you may be able to accomplish this more easily
